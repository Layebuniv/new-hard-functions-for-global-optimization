 ...
 for nbex=1:Runs %
     rng('shuffle')        
      %----------------STO paramaters
        ...
        FES=0;
        MAX_FES=100000;   % maximum number of function evaluation
   ...
   %------------------escape local minimma-----------------------------
    ...
    cuve1{nfun}.cuvre=curve;
end

save('curvemtsa10','curve');
% for i=20:20
